...
async function openModal(movieId) {
  ...
  <img src="${`https://image.tmdb.org/t/p/w500/${detResp.backdrop_path}`}" class="movie__backdrop"></img>
  <div class="movie__backdrop--darkened"></div>
</div>
<h1 class="movie__h"><span class="movie__title">${detResp.title}</span></h1>
<div class="movie__info">
  <img src="${`https://image.tmdb.org/t/p/w500/${detResp.poster_path}`}" alt="" class="movie__poster">
  <div class="movie__info--text">
      ...
      <p class="movie__overview"><span class="accent">Опис: </span><p>${detResp.overview}</p></p>
  </div>
</div>`
}
